...
beautiful.init("/home/aitjcize/.config/awesome/themes/daes/theme.lua")
...
tags = {}
tags.settings = {
    { name = "Home",  layout = layouts[1] },
    { name = "Terminal",  layout = layouts[1] },
    { name = "Internet",  layout = layouts[1] },
    { name = "Alternate", awful.layout.suit.max.fullscreen },
...
for s = 1, screen.count() do
    ...
    for i, v in ipairs(tags.settings) do
        tags[s][i] = awful.tag.add(v.name, {screen = s, layout = v.layout})
    end
...
systemenu = {
   ...
   { "Htop", "xterm -e htop" },
   { "Vbox", "virtualbox" },
   { "WinXP", "VBoxManage startvm WindowsXP" },
}
...
separator:set_markup('<span color="#a2a2a2"> </span>')
...
vicious.register(battwidget, vicious.widgets.bat, 'Batt: <span color="#a2a2a2">$1$2% / $3</span>', 60, 'BAT0')
