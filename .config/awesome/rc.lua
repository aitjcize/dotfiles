...
tags = {}
tags.settings = {
    { name = "Home",  layout = awful.layout.layouts[1] },
    { name = "Terminal",  layout = awful.layout.layouts[1] },
    { name = "Internet",  layout = awful.layout.layouts[1] },
    { name = "Alternate", awful.layout.suit.max.fullscreen },
    { name = "Media", layout = awful.layout.layouts[2] },
}
...
awful.screen.connect_for_each_screen(function(s)
    ...
    for i, v in ipairs(tags.settings) do
        awful.tag.add(v.name, {screen = s, layout = v.layout})
    end
